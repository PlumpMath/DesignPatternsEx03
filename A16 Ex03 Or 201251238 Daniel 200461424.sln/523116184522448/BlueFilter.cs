...
namespace _EventFullyApp
{
    class BlueFilter : FilterChain
    {
        ...
        public override Image ApplyFilter(Image i_ImageToFilter, String i_filter)
        {
            ...
            if (i_filter.Equals("blue"))
            {
                filteredImage = applyBlueFilter(i_ImageToFilter);
            }
        ...
        private Bitmap applyBlueFilter(Image sourceImage)
        {
            ColorMatrix colorMatrix = new ColorMatrix(new float[][] 
                {
                        new float[]{1f, 0f, 1f, 0, 0},
                        new float[]{0f, 1f, 1f, 0, 0},
                        new float[]{0f, 0f, 2f, 0, 0},
                        new float[]{0, 0, 0, 1, 0},
                        new float[]{0, 0, 0, 0, 1}
                });
